...
public class ForgotPasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    {
        mButtonSubmit=(Button)findViewById(R.id.button_reset_submit);
        mPassword =(EditText)findViewById(R.id.textinputedittext_reset_password);
        mConfirmPassword =(EditText)findViewById(R.id.textinputedittext_reset_confirm_password);
        mMobile =(EditText)findViewById(R.id.edittext_reset_mobile_number);
        mReset =(Button)findViewById(R.id.button_reset);
        cardView =(CardView)findViewById(R.id.card_credentials);
        cardViewSubmit =(CardView)findViewById(R.id.card_validate);
    }
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if(response.code() == 200)
                {
                    ...
                    Toast.makeText(getApplicationContext(),mStoredMobileNumber,Toast.LENGTH_LONG).show();
