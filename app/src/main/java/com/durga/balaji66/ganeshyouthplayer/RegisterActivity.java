...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputEditText mFirstName, mLastName, mFatherName, mMobileNumber, mPassword, mConfirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date date = new Date();
        mDate = String.valueOf(formatter.format(date));
        //System.out.println("hai date"+ formatter.format(date));
    ...
    public void initializeViews() {
        ...
        mFatherName = findViewById(R.id.editTextFatherName);
        mMobileNumber = findViewById(R.id.editTextMobileNumber);
    ...
    public void retrofitSignUpCode() {
        ...
        Call<ResponseBody> call = APIUrl.getmInstance().getApi().newPlayerRegistration(name, fatherName, phone, password, mDate);
        //calling the api
